...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RobusTestHub.Device2();
  });
  ...
  describe('Device2', function() {
    it('should create an instance of Device2', function() {
      // uncomment below and update the code to test Device2
      //var instane = new RobusTestHub.Device2();
      //expect(instance).to.be.a(RobusTestHub.Device2);
    });
