...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RobusTestHub.Device3();
  });
  ...
  describe('Device3', function() {
    it('should create an instance of Device3', function() {
      // uncomment below and update the code to test Device3
      //var instane = new RobusTestHub.Device3();
      //expect(instance).to.be.a(RobusTestHub.Device3);
    });
