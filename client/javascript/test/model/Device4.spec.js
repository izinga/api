...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RobusTestHub.Device4();
  });
  ...
  describe('Device4', function() {
    it('should create an instance of Device4', function() {
      // uncomment below and update the code to test Device4
      //var instane = new RobusTestHub.Device4();
      //expect(instance).to.be.a(RobusTestHub.Device4);
    });
