...
*DefaultApi* | [**jira_2**](docs/DefaultApi.md#jira_2) | **GET** /admin/v3/bug/config/jira/{congfig_id}/projects | get all jira project for given config
...
*DefaultApi* | [**jira_config_5**](docs/DefaultApi.md#jira_config_5) | **PATCH** /admin/v3/bug/config/jira/{jira_config_id} | update all projects for a jira config
