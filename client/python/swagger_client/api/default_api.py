...
class DefaultApi(object):
    ...
    def neuron(self, **kwargs):  # noqa: E501
        """get devices status, in progress, allready added  # noqa: E501

        get devices status, in progress, allready added  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.neuron(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.neuron_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.neuron_with_http_info(**kwargs)  # noqa: E501
            return data

    def neuron_with_http_info(self, **kwargs):  # noqa: E501
        """get devices status, in progress, allready added  # noqa: E501

        get devices status, in progress, allready added  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.neuron_with_http_info(async=True)
        >>> result = thread.get()
